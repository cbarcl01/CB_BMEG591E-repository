...
First we identified a new 'taskfile', which contained the iPSC ChIP information. We then ran this pipeline with our new taskfile and got the following output:
