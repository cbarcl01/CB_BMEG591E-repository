...
As the raw data was not available in the time constraints, scaffolds in .fasta were used. In this instance Fastqc cannot be run so the following script was rub to assess the GC content.
