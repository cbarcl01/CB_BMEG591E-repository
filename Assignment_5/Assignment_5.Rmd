...
The peaks appear to be different for H3K27me3, with little variation in expression, however for cluster 1 it seems to be that there is a downturn in expression between TSS and TES. This is likely because it represents inactive transcription (rather than active for the other two marks).
