...
**Explore this region, what do you see? Is there something similar across all the different files that stands out on this region? Is there anything peculiar about the DNA sequence at this locus?3 pt**


**Add screenshot of your IGV session here**

##![Image screenshot name 1](C:\Users\cbarc\OneDrive\Desktop\git_temp\CB_BMEG591E-repository\Assignment_5\IGV_Screenshot.png)
...
***Explain what a blacklisted region is and if you think this region should be excluded in a ChIP-seq analysis***
...
##![Heatmap for normalised bigwig files](C:\Users\cbarc\OneDrive\Desktop\git_temp\CB_BMEG591E-repository\Assignment_5\Heatmap1.png)
...
![Heatmap with raw bigwig files](C:\Users\cbarc\OneDrive\Desktop\git_temp\CB_BMEG591E-repository\Assignment_5\Heatmap2.png)
...
pscp -P 22 cbarcl01@gi-edu-sv4.bme.ubc.ca:/home/cbarcl01/Assignment_5/H3K4me3_callpeaks.narrowPeak C:\Users\cbarc\OneDrive\Desktop 
...
computeMatrix scale-regions -S /usr/local/share/data/assignment_5/H3K4me3_norm.bw /usr/local/share/data/assignment_5/H3K27ac_norm.bw /usr/local/share/data/assignment_5/H3K27me3_norm.bw -R /home/cbarcl01/Assignment_5/H3K27ac_callpeaks.narrowPeak -a 1000 -b 1000 -o ./computematrixRP.gz

plotHeatmap -m ./computematrix2.gz \
     -out Heatmap2.png \
     --colorMap 'Blues' --kmeans 3

computeMatrix scale-regions -S /usr/local/share/data/assignment_5/H3K4me3_norm.bw /usr/local/share/data/assignment_5/H3K27ac_norm.bw /usr/local/share/data/assignment_5/H3K27me3_norm.bw -R /home/cbarcl01/Assignment_5/H3K4me3_callpeaks.narrowPeak  -a 1000 -b 1000 -o ./computematrixRP.gz

plotHeatmap -m ./computematrix2.gz \
     -out Heatmap2.png \
     --colorMap 'Blues' --kmeans 3

computeMatrix scale-regions -S /usr/local/share/data/assignment_5/H3K4me3_norm.bw /usr/local/share/data/assignment_5/H3K27ac_norm.bw /usr/local/share/data/assignment_5/H3K27me3_norm.bw -R /home/cbarcl01/Assignment_5/H3K27Me3_callpeaks.broadPeak  -a 1000 -b 1000 -o ./computematrixRP.gz
